    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">ORDER PESANAN </div>
            </a>
                            ...
                            <div class="white-box">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered thead-dark" id="table">
                                        ...
                                        <tbody>
                                            <?php
                                            $get = mysqli_query($conn, "SELECT * FROM pesanan p INNER JOIN pelanggan pl ON p.idpelanggan = pl.idpelanggan");
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $jumlah; ?></td>
                                                    <td>
                                                        <a class="btn btn-warning" href="view.php?idpesan=<?= $idpesanan; ?>">Detail</a>
                                                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#hapus<?= $idpesanan; ?>">Hapus</button>
                                                    </td>
                                                </tr>
                                                ...
                                                <!-- Akhir Modal untuk Hapus Pesanan -->
                                            <?php endwhile; ?>
                                        </tbody>
                                    </table>
                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" id="submitBtn" class="btn btn-info" name="tambahpesanan">Submit</button>
